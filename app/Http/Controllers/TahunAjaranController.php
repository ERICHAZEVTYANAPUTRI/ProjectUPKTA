...
public function store(Request $request)
{
    ...
    // Hanya admin jurusan yang boleh menambahkan tahun ajaran
...
$request->validate([
    ...
    $tahunAjaran = TahunAjaran::create([
        'tahun' => $request->tahun,
        'semester' => strtolower($request->semester), // Pastikan lowercase
...
public function show($id)
{
    ...
    // Ekstrak tahun_awal dan tahun_akhir dari kolom 'tahun' (misalnya: "2024/2025")
