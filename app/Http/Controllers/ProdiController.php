...
public function store(Request $request)
{
    ...
    // Pastikan hanya admin jurusan yang boleh menambahkan prodi
    ...
    // Cari jurusan berdasarkan nama jurusan dan kodejurusan dari tabel users
...
public function update(Request $request, $id)
{
    ...
    // Ambil data jurusan berdasarkan nama dan kode dari user
$jurusan = Jurusan::where('namajurusan', $user->jurusan)
                  ->where('kodejurusan', $user->kodejurusan)
                  ->first();
