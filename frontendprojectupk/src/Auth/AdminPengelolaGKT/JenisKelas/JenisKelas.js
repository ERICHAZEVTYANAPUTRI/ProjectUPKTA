        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    "http://localhost:8000/api/jeniskelas"
                );
    ...
    const handleDelete = async (id) => {
        swal({
            ...
            if (willDelete) {
                try {
                    await axios.delete(
                        `http://localhost:8000/api/jeniskelas/${id}`
                    );
    ...
    const handleSaveJenisKelas = async (data, id = null) => {
        try {
            if (id) {
                ...
                swal(
                    "Berhasil!",
                    "Data jeniskelas berhasil diperbarui.",
                    "success"
                );
            } else {
                ...
                swal(
                    "Berhasil!",
                    "Data jeniskelas berhasil ditambahkan.",
                    "success"
                );
            }
            const response = await axios.get(
