...
const DetailRuangan = () => {
    ...
    const handleImageChange = async (event) => {
        ...
        try {
            await axios.post(
                `http://localhost:8000/api/ruangan/${roomId}/update-gambar`,
                formData,
                {
                    headers: {
            ...
            const updatedRoom = await axios.get(
                `http://localhost:8000/api/ruangan/${gedungId}/detail/${roomId}`
            );
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            try {
                ...
                const [jenisKelasRes, modelKelasRes, saranaKelasRes] =
                    await Promise.all([
        ...
        const fetchData = async () => {
            ...
            try {
                const res = await axios.get(
                    `http://localhost:8000/api/ruangan/${roomId}/detail-peminjaman`
                );
                    ...
                    <Box sx={{ padding: 2 }}>
                        ...
                        >
                            <Box
                                ...
                                onClick={
                                    canEditImage ? handleImageClick : undefined
                                }
                            >
                                <img
                            ...
                            <Box sx={{ width: "60%", padding: 3 }}>
                                ...
                                >
                                    ...
                                    <Typography variant="body2">
                                        : Ruangan berada di lantai {room.lantai}
                                    </Typography>
                                    ...
                                    <Typography variant="body2">
                                        : Ruangan ini berjenis{" "}
                                        {mapIdsToNames(
                                            typeof room.jeniskelas === "string"
                                                ? JSON.parse(room.jeniskelas)
                                                : room.jeniskelas,
                                            jenisKelasList
                                        )}
                                    </Typography>
                                    ...
                                    <Typography variant="body2">
                                        : Ruangan ini memiliki model{" "}
                                        {mapIdsToNames(
                                            typeof room.modelkelas === "string"
                                                ? JSON.parse(room.modelkelas)
                                                : room.modelkelas,
                                            modelKelasList
                                        )}
                                    </Typography>
                                    ...
                                    <Typography variant="body2">
                                        : Ruangan ini memiliki sarana pendukung{" "}
                                        {mapIdsToNames(
                                            typeof room.saranakelas === "string"
                                                ? JSON.parse(room.saranakelas)
                                                : room.saranakelas,
                                            saranaKelasList
                                        )}
                                    </Typography>
