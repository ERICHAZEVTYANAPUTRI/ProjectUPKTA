...
const DetailPeminjamanDiluarPerkuliahan = ({ open }) => {
    const { id } = useParams();
        ...
        const fetchDetail = async () => {
            try {
                const res = await axios.get(
                    `http://localhost:8000/api/pengajuan-kegiatan/${id}`
                );
...
export default DetailPeminjamanDiluarPerkuliahan;
