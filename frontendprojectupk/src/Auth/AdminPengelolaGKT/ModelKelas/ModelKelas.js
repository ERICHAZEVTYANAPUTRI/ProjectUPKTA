        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    "http://localhost:8000/api/modelkelas"
                );
    ...
    const handleDelete = async (id) => {
        swal({
            ...
            if (willDelete) {
                try {
                    await axios.delete(
                        `http://localhost:8000/api/modelkelas/${id}`
                    );
    ...
    const handleSaveModelKelas = async (data, id = null) => {
        try {
            if (id) {
                ...
                swal(
                    "Berhasil!",
                    "Data modelkelas berhasil diperbarui.",
                    "success"
                );
            } else {
                ...
                swal(
                    "Berhasil!",
                    "Data modelkelas berhasil ditambahkan.",
                    "success"
                );
            }
            const response = await axios.get(
