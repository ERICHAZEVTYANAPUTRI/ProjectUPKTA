...
const SaranaKelas = () => {
    ...
    useEffect(() => {
        ...
        const current = pageOptions.find(
            (option) =>
                option.value.toLowerCase().replace(/\/$/, "") === normalizedPath
        );
        ...
        const fetchData = async () => {
            try {
                const response = await axios.get(
                    "http://localhost:8000/api/saranakelas"
                );
    ...
    const handleDelete = async (id) => {
        swal({
            ...
            if (willDelete) {
                try {
                    await axios.delete(
                        `http://localhost:8000/api/saranakelas/${id}`
                    );
    ...
    const handleSaveSaranaKelas = async (data, id = null) => {
        try {
            if (id) {
                ...
                swal(
                    "Berhasil!",
                    "Data saranakelas berhasil diperbarui.",
                    "success"
                );
            } else {
                ...
                swal(
                    "Berhasil!",
                    "Data saranakelas berhasil ditambahkan.",
                    "success"
                );
            }
            const response = await axios.get(
