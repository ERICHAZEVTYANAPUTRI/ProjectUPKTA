...
const PengajuanMenungguPersetujuan = ({ open }) => {
    ...
    const paginatedData = dataPending.slice(
        (page - 1) * rowsPerPage,
        page * rowsPerPage
    );
    ...
    return (
        ...
        >
            ...
            {paginatedData.length === 0 ? (
                ...
                >
                    Tidak ada pengajuan Peminjaman menunggu persetujuan.
                </Typography>
            ) : (
                <Box
                ...
                >
                    {paginatedData.map((item) => (
                        ...
                        >
                            <Avatar
                                src={`http://localhost:8000/storage/${item.mahasiswa.foto}`}
                                alt={item.mahasiswa.nama_lengkap}
