        ...
        return (
            ...
            >
                ...
                {payload.map((entry) => (
                    <div
                        key={entry.dataKey}
                        style={{ color: entry.stroke, fontWeight: 600 }}
                    >
...
const RuanganLineChart = ({ data }) => {
    ...
    const processedData = fullHours.map((jam) => {
        ...
        return {
            jam,
            dipinjam:
                found && found.dipinjam !== null && found.dipinjam !== "null"
                    ? Number(found.dipinjam)
                    : null,
            diperbaiki:
                found &&
                found.diperbaiki !== null &&
                found.diperbaiki !== "null"
                    ? Number(found.diperbaiki)
                    : null,
            kosong:
                found && found.kosong !== null && found.kosong !== "null"
                    ? Number(found.kosong)
                    : null,
        };
    });
    ...
    return (
        ...
        >
            ...
            <Typography sx={{ color: "#666", mb: 2, fontSize: "0.85rem" }}>
                Jumlah ruangan berdasarkan status tiap jam.
            </Typography>
