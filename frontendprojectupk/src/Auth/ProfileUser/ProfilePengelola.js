...
const PengelolaProfile = ({ user, setUser, open }) => {
  ...
  const handleSaveChanges = async () => {
    ...
    try {
      const response = await axios.post(`http://localhost:8000/api/userpengelola/${user.id}`, formData);
...
export default PengelolaProfile;
