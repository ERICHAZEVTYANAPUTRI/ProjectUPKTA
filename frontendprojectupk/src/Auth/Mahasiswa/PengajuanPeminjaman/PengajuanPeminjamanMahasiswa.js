...
const PengajuanPeminjamanMahasiswaForm = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                ...
                const [mkRes, gedungRes, jurusanRes, prodiRes] =
                    await Promise.all([
    ...
    const handleMatakuliahSelect = (selectedOption) => {
        setFormData((prev) => ({
            ...
            dosen: selectedOption ? selectedOption.dosen : "",
        }));
    };
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const payload = {
                ...
                hari: new Date(formData.tanggal)
                    .toLocaleDateString("id-ID", { weekday: "long" })
                    .toLowerCase(),
                jammulai: formData.jammulai,
                jamselesai: formData.jamselesai,
                kodematakuliah: formData.kodematakuliah,
                    ...
                    <Card className="p-4">
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control
                                type="text"
                                name="jurusan"
                                value={getNamaJurusan(formData.jurusan)}
                                readOnly
                            />
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Form.Control
                                type="text"
                                name="prodi"
                                value={getNamaProdi(formData.prodi)}
                                readOnly
                            />
                        </Form.Group>
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Select
                                ...
                                onChange={handleMatakuliahSelect}
                                value={matakuliahOptions.find(
                                    (opt) => opt.value === formData.matakuliah
                                )}
                        ...
                        <Form.Group className="mb-3">
                            ...
                            <Button
                                ...
                                onClick={() => setShowGedungModal(true)}
                            >
                                Pilih Gedung
                            </Button>
                        </Form.Group>
