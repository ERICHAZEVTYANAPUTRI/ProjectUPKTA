...
const DetailPenjadwalanRuanganPerkuliahan = ({ open }) => {
  const { id } = useParams();
  ...
  useEffect(() => {
    const fetchDetail = async () => {
      try {
        const res = await axios.get(`http://localhost:8000/api/penjadwalanruanganget/${id}`);
  ...
  const { kelas, mahasiswa, matakuliah, prodi, dosen, hari, jammulai, jamselesai, kebutuhankelas, statuspeminjaman, kurikulum, ruangan } = data || {};
            ...
            <Grid alignItems="flex-start" justifyContent="center" container spacing={3}>
              ...
              <Grid item xs={12} md={6} sx={{ height: "100%" }}>
                ...
                >
                  ...
                  <Box sx={{ display: "flex", gap: 2 }}>
                    <Avatar variant="rounded" src={data?.ruangan?.gambar ? `http://localhost:8000/storage/${data.ruangan.gambar}` : undefined} sx={{ width: 150, height: 120 }} />
                    <Box>
                      {[
                        ...
                        <Box
                          ...
                          sx={{
                            display: "flex",
                            flexWrap: "wrap", // ⬅️ agar responsif saat panjang
                            mb: 0.5,
                            wordBreak: "break-word", // ⬅️ teks panjang tetap dipotong baris
                          }}
                        >
                          <Box sx={{ minWidth: "120px", fontWeight: 500 }}>{label}</Box>
                          <Box sx={{ width: "20px", fontWeight: "bold" }}>:</Box>
                          <Box sx={{ flex: 1 }}>{value}</Box> {/* ⬅️ flex agar isi mengikuti ruang */}
                        </Box>
                      ))}
                    </Box>
                  </Box>
              ...
              {/* Bawah: Detail Mata Kuliah, Dosen, dan Jadwal */}
              <Grid item xs={12}>
                  ...
                  <Grid item xs={12} md={4}>
                    ...
                    >
                      ...
                      {[
                        ...
                        { label: "Kebutuhan", value: kebutuhankelas || "-" },
                  ...
                  <Grid item xs={12} md={4}>
                    ...
                    >
                      ...
                      {[
                        ...
                        { label: "Program Studi", value: dosen?.prodi?.namaprodi || "-" },
...
export default DetailPenjadwalanRuanganPerkuliahan;
