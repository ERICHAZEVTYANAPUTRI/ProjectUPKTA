  ...
  return (
    <div className="sop-container1" style={{ backgroundColor: "#f5f6fa", minHeight: "100vh", fontFamily: "sans-serif" }}>
      ...
      <div className="card-container1" style={{ display: "flex", justifyContent: "center", padding: "30px" }}>
        ...
        >
          <h2 style={{ color: "#008080", fontSize: "20px", marginBottom: "20px", fontWeight: "600" }}>Poin-Poin SOP Pengembalian Ruangan:</h2>
          <ul
            className="sop-list"
            style={{
              listStyle: "none",
...
export default SopPengembalian;
